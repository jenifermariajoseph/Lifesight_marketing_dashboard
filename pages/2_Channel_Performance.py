...
# After the Marketing Cost Breakdowns section and its containers

# Add some spacing between sections
st.markdown("<div style='height: 30px;'></div>", unsafe_allow_html=True)

# Remove these lines (lines 290-320):
# # Create campaign metrics for performance analysis
# st.markdown("<h1 class='main-header'>Campaign Performance Analysis</h1>", unsafe_allow_html=True)
# 
